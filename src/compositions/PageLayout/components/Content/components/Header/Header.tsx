...
const Content: React.FC = () => {
  ...
  return (
    <div className="fixed top-12 pt-4 pb-2 px-2 py-2 bottom-0 left-0 nr:w-[22.5rem] mb:w-full bg-bg-l0 overflow-auto no-scrollbar">
      <LiveSwitcher />
...
const Header: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="py-2 px-2 bg-bg-l0">
